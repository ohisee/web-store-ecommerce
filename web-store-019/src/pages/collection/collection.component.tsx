...
interface CollectionPageProps {
  collection: ShopData | undefined | null
}
 ...
 * in addition, after switching to load shop data collection from database, the 
 * initial shop data collection is null, so we need to wait for loading data to 
